...
def create_app(config_name=None):
    ...
    # from routes.monitoring import monitoring_bp  # Temporarily disabled due to circular import
    ...
    # app.register_blueprint(monitoring_bp, url_prefix="/admin")  # Temporarily disabled
