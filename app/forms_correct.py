...
from wtforms import StringField, IntegerField, SelectField, TextAreaField, BooleanField, RadioField, PasswordField, SubmitField, FieldList, FormField
...
class AdminFilterForm(FlaskForm):
    """관리자 검색/필터 폼"""
    search = StringField('검색 (이름, 부서)', validators=[Optional()])
