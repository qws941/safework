...
class FileManager:
    ...
    def cleanup_old_files(self, days_to_keep=30, dry_run=False):
        ...
        for file_path in self.base_path.rglob('*'):
            if (file_path.is_file() and 
                'backups' not in str(file_path) and 
    ...
    def create_backup(self, backup_type='incremental'):
        ...
        safework_logger.log_event(
            'info',
            'backup_start',
            f'Starting {backup_type} backup creation'
        )
        ...
        try:
            ...
            metadata = {
                ...
                'backup_size_mb': round(backup_filepath.stat().st_size / (1024**2), 2),
    ...
    def verify_file_integrity(self):
        ...
        try:
                ...
                try:
                    ...
                    if not csv_path.exists():
                        verification_results['missing_files'].append({
                            ...
                            'missing_csv': str(csv_path.relative_to(self.base_path))
                        })
                    else:
            ...
            verification_results['success'] = len(verification_results['corrupted_files']) == 0
            verification_results['integrity_score'] = (
                verification_results['verified_files'] / max(verification_results['total_files'], 1) * 100
            )
