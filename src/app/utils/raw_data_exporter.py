...
class RawDataExporter:
    ...
    def _generate_filename(self, survey_id: int, form_type: str, format_type: str = 'json') -> str:
        """
    ...
    def export_json(self, survey_data: Dict[str, Any], survey_id: int, form_type: str) -> str:
        """
    ...
    def export_csv(self, survey_data: Dict[str, Any], survey_id: int, form_type: str) -> str:
        """
    ...
    def _flatten_data(self, data: Dict[str, Any], survey_id: int, form_type: str) -> Dict[str, Any]:
        """
                ...
                for key, value in obj.items():
                    ...
                    if isinstance(value, (dict, list)):
                        if isinstance(value, list):
                            # 리스트는 JSON 문자열로 변환
                            flat_data[new_key] = json.dumps(value, ensure_ascii=False, default=str)
                        else:
    ...
    def export_both_formats(self, survey_data: Dict[str, Any], survey_id: int, form_type: str) -> Dict[str, str]:
        """
    ...
    def create_backup(self, survey_id: int, form_type: str) -> bool:
        ...
        try:
            ...
            current_app.logger.error(f"❌ Backup failed for survey {survey_id}: {str(e)}")
            return False
    ...
    def list_files(self, form_type: Optional[str] = None) -> Dict[str, list]:
        ...
        file_info['total_count'] = len(file_info['json_files']) + len(file_info['csv_files'])
        return file_info
        ...
        for form_type in form_types:
            ...
            if form_dir.exists():
                ...
                for file_path in json_files + csv_files:
                    created_dates.append(datetime.fromtimestamp(file_path.stat().st_ctime))
...
def export_survey_raw_data(survey_data: Dict[str, Any], survey_id: int, form_type: str, 
                          format_types: list = None) -> Dict[str, str]:
    """
