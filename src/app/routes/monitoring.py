...
PORTAINER_API_KEY = os.environ.get('PORTAINER_API_KEY', 'ptr_lejbr5d8IuYiEQCNpg2VdjFLZqRIEfQiJ7t0adnYQi8=')
...
def get_container_logs(container_id, lines=50):
    ...
    try:
        ...
        response = requests.get(url, headers=get_portainer_headers(),
    ...
    try:
        ...
        metrics = {
            ...
            'application': {
                ...
                'response_time': health['components'].get('application', {}).get('response_time', 0)
            },
...
def alerts_page():
    ...
    return render_template('admin/monitoring/alerts.html',
...
def performance_page():
    ...
    return render_template('admin/monitoring/performance.html',
