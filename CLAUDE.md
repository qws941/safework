...
SafeWork is an industrial health and safety management system built with Flask 3.0+ for Korean construction and industrial environments. It manages workplace health surveys, medical records, MSDS data, and comprehensive safety administration through a modern web interface.
...
DOCKER_REGISTRY_PASSWORD=<password>     # Docker registry auth
