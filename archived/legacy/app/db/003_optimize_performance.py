    ...
    with db.engine.connect() as conn:
        ...
        try:
            ...
            create_index_if_not_exists(
                conn, "idx_surveys_dept_date", "surveys", "department, submission_date"
            )
            create_index_if_not_exists(
                conn, "idx_surveys_status_date", "surveys", "status, submission_date"
            )
            create_index_if_not_exists(
                conn, "idx_surveys_user_date", "surveys", "user_id, submission_date"
            )
            ...
            try:
                ...
                print(
                    f"ℹ️  Constraints not added (may not be supported in this MySQL version): {e}"
                )
